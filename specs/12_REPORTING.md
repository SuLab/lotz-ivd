# Module 12: Reporting & Reproducibility
...
- `results/final_report.html` — comprehensive analysis report (Jupyter notebook converted to HTML via `nbconvert`)
- `results/figures/` — publication-quality figures (PDF for vector, 300 dpi PNG for raster, 180mm max width)
...
- Environment specification (`requirements_frozen.txt` with pinned versions)
