  ...
  - Analysis-/decision-dependent comments left in place as visible "> **TODO**" callouts.
Tables 1-3 transcribed from the rendered PDF pages (text layer was scrambled); values verified
(Table 2 sums to 1,823). Figures are the real fig01-fig13 assets from docs/manuscript_figures/
(embedded 2026-06-12), with the ML-edited caption text retained.
-->
